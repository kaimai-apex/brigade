      ...
      <main className="mx-auto max-w-6xl px-6 pb-20">
        <div className="py-10">
          ...
          <p className="mt-4 max-w-2xl text-lg text-ink/70">
            Everyone on the platform — browse chefs, bartenders, servers, and event
            staff. Send connection requests to grow your network.
          </p>
        </div>

        {profiles.length === 0 ? (
          <Card className="p-12 text-center">
            <p className="font-display text-2xl font-bold">Explore hospitality professionals</p>
