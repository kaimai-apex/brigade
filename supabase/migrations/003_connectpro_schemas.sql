-- ConnectPro microservice schemas (run in Supabase SQL editor if not using CLI)
-- IMPORTANT: On Supabase, do NOT run this file — use 003_connectpro_schemas_supabase.sql instead.
-- Supabase reserves the `auth` schema for GoTrue; ConnectPro auth uses `connectpro_auth` there.
